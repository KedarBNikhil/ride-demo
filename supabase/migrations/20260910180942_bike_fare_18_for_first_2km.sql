...
-- Bike only: ₹18 includes the first 2 km. Each started 100 m thereafter costs ₹1.
-- Auto pricing, promotion state, dispatch, and pickup-distance pricing are unchanged.
...
begin
  ...
  v_base_fare := case when p_ride_type = 'bike' then 18 else round((25 * power(1.5::numeric, p_passenger_count - 1))::numeric, 2) end;
