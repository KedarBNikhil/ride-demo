...
export function CaptainRideDetailsScreen({ rideId, onBack }: { rideId: string; onBack: () => void }) {
  const { t } = useTranslation();
  const [details, setDetails] = useState<CaptainRideDetails | null>(null); const [failed, setFailed] = useState(false);
